...
# Constants
const INPUT_ACTIONS = ["ui_up", "ui_down", "ui_left", "ui_right", "jump", "dash", "fire",
"ui_up_2", "ui_down_2", "ui_left_2", "ui_right_2", "jump_2", "dash_2", "fire_2" ]
const CONFIG_FILE = "user://input_map.cfg"
